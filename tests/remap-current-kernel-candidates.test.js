...
test('fresh remap of low-coupling kernel candidates', () => {
  ...
  const hardForbidden = /\b(goTo|renderCurrent|timeline|scrubber|autoplay|DEP|route|fix|aircraft|map|planner|interpol|coordinate|runway|airport|movement|motion|realMapState|leaflet|geometry)\b/i;
  ...
  for (const row of rows.slice(0, 40)) {
    console.log('FRESH_REMAP|' + JSON.stringify(row));
  }
