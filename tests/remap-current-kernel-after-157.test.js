...
test('fresh remap of low-coupling kernel candidates after PR 157', () => {
  ...
  const sensitiveTerms = [
    ...
    'bearing','centroid','polygon','motion','realmapstate','leaflet','geometry'
  ];
  ...
  for (const decl of declarations) {
    ...
    rows.push({
      ...
      score,
      preview: source.replace(/\s+/g, ' ').slice(0, 260)
    });
  }
