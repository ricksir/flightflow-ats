...
test('IIFE usa groundCentroid pelo coordinate-utils sem alterar os dois consumidores', () => {
  ...
  assert.ok(kernel.includes('{ normalizeCoordinateInput, validAerodromeCoordinate, formatGeoCoord, atsCoordinateLabel, groundCentroid, runwayTokens, runwayHeading } = CoordinateUtils;'));
