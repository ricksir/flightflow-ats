...
test('fresh remap of low-coupling kernel candidates after PR 182', () => {
  ...
  for (const decl of declarations) {
    ...
    // Avoid the historical false positive where Array.prototype.map() was treated
    // as map coupling, while still rejecting real map variables and identifiers.
  ...
  console.log('FRESH_REMAP_BASE|05368d5e752415467f74e87358e74a7e0a09f519');
